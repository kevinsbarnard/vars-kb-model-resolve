...
def print_model(model: Model):
    ...
    for model_class in model.classes:
        ...
        for concept in sorted(model_class.concepts, key=(lambda concept: (concept.concept, concept.part))):
            print(f'- {concept.concept}' + (f' ({concept.part})' if concept.part != 'self' else ''))
        print()
